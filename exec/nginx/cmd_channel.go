...
// NewCmdChannel returns a local channel for invoking the host command
func NewCmdChannel() spec.Channel {
	return &CmdChannel{}
}

func (l *CmdChannel) Name() string {
	return "powershell"
}

func (l *CmdChannel) Run(ctx context.Context, script, args string) *spec.Response {
	return execScript(ctx, script, args)
}

func (l *CmdChannel) GetScriptPath() string {
	return util.GetProgramPath()
}

func (l *CmdChannel) GetPidsByProcessCmdName(processName string, ctx context.Context) ([]string, error) {
	return nil, nil
}

func (l *CmdChannel) GetPidsByProcessName(processName string, ctx context.Context) ([]string, error) {
	return nil, nil
}

func (l *CmdChannel) GetPsArgs(ctx context.Context) string {
...
func (l *CmdChannel) IsAlpinePlatform(ctx context.Context) bool {
	var osVer = ""
...
func (l *CmdChannel) IsAllCommandsAvailable(ctx context.Context, commandNames []string) (*spec.Response, bool) {
	return nil, true
}

func (l *CmdChannel) IsCommandAvailable(ctx context.Context, commandName string) bool {
	response := l.Run(ctx, "command", fmt.Sprintf("-v %s", commandName))
	return response.Success
}

func (l *CmdChannel) ProcessExists(pid string) (bool, error) {
...
func (l *CmdChannel) GetPidUser(pid string) (string, error) {
	p, err := strconv.Atoi(pid)
	if err != nil {
		return "", err
	}
...
func (l *CmdChannel) GetPidsByLocalPorts(ctx context.Context, localPorts []string) ([]string, error) {
...
func (l *CmdChannel) GetPidsByLocalPort(ctx context.Context, localPort string) ([]string, error) {
	return nil, nil
}
